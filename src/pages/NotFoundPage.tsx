...
const NotFoundPage: React.FC = () => {
  ...
  return (
    <div
      className="page-content min-h-screen bg-gradient-to-br from-brand-light to-white flex items-center"
      style={{ opacity: 0 }}
    >
      <div className="container mx-auto max-w-4xl px-4 py-12 text-center">
        ...
        <div className="mb-8">
          <img
            ...
            className="w-16 h-16 mx-auto mb-4 opacity-60 object-contain"
          />
        </div>
        ...
        <div className="bg-white/95 backdrop-blur-sm rounded-xl p-12 shadow-lg border-2 border-brand-accent/20 max-w-2xl mx-auto">
          ...
          <p className="text-lg text-brand-text/80 mb-8 leading-relaxed">
            Se pare că pagina pe care o căutați nu există sau a fost mutată. Nu
            vă faceți griji - vă pot ghida către informațiile de care aveți
            nevoie.
          </p>
          ...
          <div className="bg-brand-accent/10 rounded-lg p-6 mb-8 border-l-4 border-brand-accent">
            <blockquote className="text-brand-primary italic">
              "Uneori, calea către destinație ne învață mai mult decât
              destinația însăși."
            </blockquote>
        ...
        <div className="mt-8 text-center">
          <p className="text-brand-text/60 text-sm">
            Dacă întâmpinați în continuare probleme, nu ezitați să mă contactați
            direct.
          </p>
        </div>
      </div>
