      ...
      <PageSchema
        breadcrumbs={[
          { name: "Acasă", url: "https://www.popescumaria.ro/" },
          {
            ...
            url: "https://www.popescumaria.ro/privacy",
          },
        ]}
        type="WebPage"
      ...
      <div className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-brand-text/80 max-w-2xl mx-auto">
            Protejarea confidențialității dumneavoastră este o prioritate pentru
            mine. Această politică explică cum sunt gestionate informațiile
            personale.
          </p>
        </div>
          ...
          <div className="space-y-8 text-brand-text leading-relaxed">
            ...
            <section>
              ...
              <p>
                ...
                Maria Popescu, psiholog clinician, colectează, utilizează și
                protejează informațiile personale ale clienților și
                vizitatorilor website-ului. Respectarea confidențialității este
                fundamentală în practica psihologică.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-brand-accent/10 p-6 rounded-lg mb-4">
                <h3 className="font-semibold text-brand-primary mb-2">
                  Informații pe care le colectez:
                </h3>
                <ul className="list-disc list-inside space-y-2 text-sm">
                  <li>
                    Informații de contact (nume, telefon, email) - doar prin
                    contactare directă
                  </li>
                  <li>
                    Informații medicale și psihologice - doar în cadrul
                    consultațiilor
                  </li>
                  <li>
                    Informații tehnice de bază despre vizitarea website-ului
                    (fără cookies)
                  </li>
                </ul>
              </div>
              <p>
                <strong>Important:</strong> Acest website NU utilizează cookies
                și NU colectează automat date personale. Informațiile sunt
                furnizate voluntar doar prin contactare directă.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                <p>
                  Toate informațiile personale sunt protejate prin măsuri de
                  securitate adecvate, incluzând stocare securizată și acces
                  restricționat. Dosarele medicale sunt păstrate conform
                  reglementărilor Colegiului Psihologilor din România.
                </p>
                <div className="bg-brand-primary/10 p-4 rounded-lg">
                  <p className="text-sm">
                    <i className="fas fa-info-circle mr-2 text-brand-primary"></i>
                    <strong>Confidențialitatea profesională:</strong> Toate
                    informațiile împărtășite în cadrul consultațiilor sunt
                    strict confidențiale, conform Codului Deontologic al
                    Psihologilor.
                  </p>
                </div>
              </div>
            ...
            <section>
              ...
              <p>
                Informațiile personale <strong>nu sunt partajate</strong> cu
                terțe părți, cu excepția situațiilor în care:
              </p>
              <ul className="list-disc list-inside space-y-2 mt-4 ml-4">
                <li>Există consimțământul explicit al clientului</li>
                <li>
                  Legea impune divulgarea (de exemplu, în cazuri de pericol
                  iminent)
                </li>
                <li>
                  Este necesar pentru colaborarea cu alți profesioniști din
                  sănătate (cu acordul clientului)
                </li>
              </ul>
            </section>
            ...
            <section>
              ...
              <div className="bg-brand-accent/10 p-6 rounded-lg">
                <p className="mb-4">
                  Pentru întrebări despre această politică sau pentru
            ...
            <section>
              ...
              <p>
                ...
                modificările în practică sau în legislație. Ultima versiune va
                fi întotdeauna disponibilă pe acest website.
              </p>
            </section>
          </div>
