      ...
      <section className="pt-20 pb-12 bg-stone-50">
        <div className="container mx-auto max-w-4xl px-4 text-center">
          ...
          <h1 className="hero-title text-4xl lg:text-5xl xl:text-6xl mb-6 leading-tight">
            <span className="hero-title font-serif font-bold text-brand-text block">Maria</span>
            <span className="hero-title font-serif font-bold text-brand-text block">Popescu</span>
          </h1>
