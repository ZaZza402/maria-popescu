      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-brand-text/80 text-sm leading-relaxed">
              Suport profesional și empatic pentru dezvoltarea personală și
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link
                  to="/"
                  className="text-brand-text/80 hover:text-brand-accent transition-colors"
                >
                  Acasă
                </Link>
              </li>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 whitespace-nowrap text-brand-text/80 hover:text-brand-accent transition-colors"
                >
                  <span
                    className="flex w-5 h-5 items-center justify-center text-brand-accent"
                    aria-hidden
                  >
              ...
              <li className="mt-4 pt-2 border-t border-brand-accent/20">
                <Link
                  to="/privacy"
                  className="text-brand-text/70 hover:text-brand-accent transition-colors text-xs"
                >
        ...
        <div className="border-t border-brand-accent/30 mt-8 pt-6 text-center">
          <p className="text-brand-text/70 text-sm">
            &copy; {new Date().getFullYear()} Maria Popescu - Psiholog
            Clinician. Toate drepturile rezervate.
          </p>
